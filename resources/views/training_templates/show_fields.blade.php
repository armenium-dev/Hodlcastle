...
<div class="row">
    ...
    <div class="col-sm-10"><iframe src="{!! route('trainingNotifyTemplates.preview', $template->id) !!}" frameborder="1" sandbox="allow-same-origin" allowfullscreen="" scrolling="auto" width="100%" height="600"></iframe></div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="btn-group">
            ...
            <div class='btn-group'>
                <a href="{!! route('trainingNotifyTemplates.index') !!}" class="btn btn-default"><i class="fa fa-caret-left"></i> Back</a>
                <a href="{!! route('trainingNotifyTemplates.edit', $template->id) !!}" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                {!! Form::button('<i class="fa fa-trash"></i> Delete', ['type' => 'submit', 'class' => 'btn btn-danger', 'onclick' => "return confirm('Are you sure?')"]) !!}
                <a href="{!! route('trainingNotifyTemplates.preview', $template->id) !!}" class="btn btn-info" target="_blank"><i class="fa fa-link"></i> Open in New tab</a>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
