@php $checkbox_id_suffix = '-a'; @endphp
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            {!! Form::select('schedule[email_template_id]', $emailTemplatesWithAttachments, null, ['class' => 'form-control', 'id' => 'email_template_id']) !!}
        </div>
        <div class="form-group">
