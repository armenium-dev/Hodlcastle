...
<div class="form-group col-sm-6 quiz-select-type">
    {!! Form::label('type', 'Type:') !!}
    {!! Form::select('type', ['checkbox' => 'Multiple', 'radio' => 'Single'], null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-12">
    {!! Form::label('text', 'Explanation:') !!}
    {!! Form::textarea('text', $pagecontent->text ? $pagecontent->text : null, ['class' => 'form-control my-editor']) !!}
</div>

<div class="form-group col-sm-12 quiz-questions">
    @if(isset($pagecontent))
        <quiz-questions-component id="{{ $pagecontent->id }}"></quiz-questions-component>
    @else
