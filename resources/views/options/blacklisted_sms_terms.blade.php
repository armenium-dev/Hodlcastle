<div class="table-responsive pr">
	...
	{!! Form::open(['route' => 'options.blacklisted_sms_terms.store', 'files' => false, 'id' => 'js_form']) !!}
		<ul id="js_terms_list" class="list-group terms">
			@foreach($blacklisted_sms_terms as $k => $term)
				<li class="js_list_item list-group-item">
					<div class="col">{!! Form::text('terms[]', $term, ['class' => 'js_sms_from form-control', 'placeholder' => 'Term']) !!}</div>
