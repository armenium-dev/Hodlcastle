...
(function( $ ) {
    ...
    $.fn.colorPick.defaults = {
        ...
        'palette': ["#1abc9c", "#16a085", "#2ecc71", "#27ae60", "#3498db", "#2980b9", "#9b59b6", "#34495e", "#2c3e50", "#FFEB3B", "#f1c40f", "#f39c12", "#e67e22", "#d35400", "#e74c3c", "#c0392b", "#ecf0f1", "#bdc3c7", "#95a5a6", "#7f8c8d"],
    ...
    $.colorPick.prototype = {
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                self.show(self.element, event.pageX - offset.left - o.leftOffset, event.pageY - offset.top - o.topOffset);
