...
use App\DynamicMail\DynMailer;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\ServiceProvider as IlluminateServiceProvider;
use Illuminate\Support\Str;
use App\DynamicMail\DynamicTransportManager;
...
class DynamicMailServiceProvider extends IlluminateServiceProvider
{
	...
	{
		$this->app->singleton('dynamic.mailer', function ($app) {
	...
	{
		$this->app->singleton('dynamic.transport', function ($app) {
	...
	public function boot()
	{
		...
		/** @var \App\Transports\DynamicTransportManager $transportManager */
		$transportManager = $this->app->make('dynamic.transport');
		$transportManager->extend('dynamic.driver', function ($app) use ($transportManager) {
